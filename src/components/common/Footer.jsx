...
<div className="u-about-page-landing-footer">
  <div className="u-about-page-landing-inner-footer">
  ...
  <div className="u-about-page-landing-footer-footer">
    <p>Copyright © 2023 YuvaPortal. All rights reserved.</p>
    <p>
      {" "}
      If you have any questions or feedback, please contact us at
      <Link className=""> info@yuvaportal.com </Link>
      Thank you for visiting YuvaPortal!
    </p>
  </div>
</div>
    </>
